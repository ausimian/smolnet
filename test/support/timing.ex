defmodule SmolNet.Test.Timing do
  ...
  #     the budget is fixed: changing a requested timeout would relax that
  #     scenario, while extending a silence check would slow the suite rather
  #     than help healthy work complete. A stalled producer can still make a
  #     fixed silence window false-pass; host scaling can reduce but not remove
  #     that scheduler-dependent risk. `quiescence/1` marks these call sites so
  #     an unscaled literal is a deliberate choice rather than an oversight.
  #
